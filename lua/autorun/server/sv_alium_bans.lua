...
AliumBanList["cfg"] = {
    ...
    ["disconnectMessage"] = [[
        ...
        Ваш STEAMID не проходит по системе блокировок сателлитов
        или(и) вы имеете особое отношение к Персонам Нон Грата 
        The Alium.

        Вы можете обжаловать решение блокировки и получить
        дополнительную информацию в комментариях касации 
        модератора The Alium - Erick's Maid.
